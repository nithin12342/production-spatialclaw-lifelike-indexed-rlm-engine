...
SERVED_NAME="qwen3.5-397b-a17b"
MAX_MODEL_LEN=98304  # 128K context
MAX_NUM_SEQS=32   # Concurrency=1 workload: minimize graph-capture pressure
TP_SIZE=8

#=============================================================================
# SLURM Configuration
#=============================================================================
JOB_NAME="vllm-qwen35-397b-a17b"
